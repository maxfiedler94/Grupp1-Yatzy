...
public class Gboard extends JFrame implements ActionListener, MouseListener{
		...
		public Gboard(int getPlayerAmount, String[] getName) {
			...
			value=0;
			rollButton= new JButton(new ImageIcon("Resourses/RollDefault.jpg"));
		...
		public void initDefaultGUI()
		{
			...
			rollButton.setPreferredSize(new Dimension(115, 50));
			...
			panel2.setPreferredSize(new Dimension(20,500));
			...
			Yatzy.frame.getContentPane().add(primary, "name_531936123301123");
